...
#include "FirstCPPGame/BatteryMan.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRSTCPPGAME_API UClass* Z_Construct_UClass_ABatteryMan_NoRegister();
	FIRSTCPPGAME_API UClass* Z_Construct_UClass_ABatteryMan();
...
// End Cross Module References
	DEFINE_FUNCTION(ABatteryMan::execOnBeginOverlap)
	{
		...
		P_GET_PROPERTY(FIntProperty,Z_Param_OtherBodyInedx);
		P_GET_UBOOL(Z_Param_bFromSweep);
		P_GET_STRUCT_REF(FHitResult,Z_Param_Out_SweepResult);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnBeginOverlap(Z_Param_HitComp,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyInedx,Z_Param_bFromSweep,Z_Param_Out_SweepResult);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics
	{
		...
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_OtherBodyInedx;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_OtherBodyInedx = { "OtherBodyInedx", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BatteryMan_eventOnBeginOverlap_Parms, OtherBodyInedx), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::NewProp_OtherBodyInedx,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABatteryMan_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABatteryMan_OnBeginOverlap, "OnBeginOverlap" }, // 2619623327
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABatteryMan, 3969743430);
	template<> FIRSTCPPGAME_API UClass* StaticClass<ABatteryMan>()
	{
		return ABatteryMan::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABatteryMan(Z_Construct_UClass_ABatteryMan, &ABatteryMan::StaticClass, TEXT("/Script/FirstCPPGame"), TEXT("ABatteryMan"), false, nullptr, nullptr, nullptr);
